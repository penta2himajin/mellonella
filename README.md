...
| [docs/bs-deltagridnet-trainability.md](docs/bs-deltagridnet-trainability.md) | Trainability spike for the BS-DeltaGridNet time-axis core: stability, ONNX, T4 throughput, GPU availability |
