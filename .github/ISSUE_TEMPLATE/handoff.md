...
- Permanent decisions migrate to docs/decisions.md (as a new D-NNN entry)
  once referenced in 2+ sessions.
...
Migrate to docs/decisions.md as a new D-NNN entry once referenced in 2+ sessions. -->
